  ...
  return (
    <section className="w-full">
      <div className="relative w-full rounded-[30px] overflow-hidden">
        <img src="/hero.png" alt="" className="w-full max-h-[640px]" />
        <div className="absolute top-1/2 left-0 transform -translate-y-1/2 w-[50%]">
          <img src="/hero-image.png" alt="" className="w-full max-h-[640px]" />
        </div>
        <div className="absolute top-1/2 right-1/4 transform translate-x-1/2 -translate-y-1/2 w-[40%]">
          <div className="mb-8">
            ...
            <p className="text-text text-xl leading-relaxed">
              Acesse nossa <strong>trilha educacional</strong> e ganhe para<br />
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="Seu e-mail" {...field} className="rounded-[30px] min-w-[300px] px-4 py-6 text-primary placeholder:text-primary opacity-50" />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="Seu nome" {...field} className="rounded-[30px] min-w-[300px] px-4 py-6 text-primary placeholder:text-primary opacity-50" />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
